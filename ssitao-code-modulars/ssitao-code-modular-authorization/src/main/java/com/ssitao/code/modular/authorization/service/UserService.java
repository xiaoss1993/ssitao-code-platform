...
import com.ssitao.code.commons.service.CreateEntityService;
import com.ssitao.code.commons.service.InsertService;
import com.ssitao.code.commons.service.QueryByEntityService;
import com.ssitao.code.commons.service.QueryService;
...
public interface UserService extends
     ...
     * 用户信息更新后,将发布事件:{@link UserModifiedEvent},在其他服务可通过监听此事件来
     * 来实现特定的操作,如清空用户权限缓存等.<br>
     *
     * @param userId   用户ID
     * @param userBean 用户信息实体类
     * @see UserModifiedEvent
