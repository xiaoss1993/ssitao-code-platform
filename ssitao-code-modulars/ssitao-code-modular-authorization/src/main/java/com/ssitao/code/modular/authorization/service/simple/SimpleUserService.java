...
import com.ssitao.code.modular.authorization.service.*;
...
import com.ssitao.code.modular.authorization.dao.UserDao;
import com.ssitao.code.modular.authorization.dao.UserRoleDao;
...
import com.ssitao.code.commons.service.AbstractService;
import com.ssitao.code.commons.service.DefaultDSLQueryService;
import com.ssitao.code.modular.authorization.service.events.ClearUserAuthorizationCacheEvent;
import com.ssitao.code.modular.authorization.service.events.UserCreatedEvent;
import com.ssitao.code.modular.authorization.service.events.UserModifiedEvent;
import com.ssitao.code.commons.utils.validate.ValidationException;
import com.ssitao.code.expands.utils.ListUtils;
...
import static com.ssitao.code.commons.service.DefaultDSLUpdateService.*;
...
public class SimpleUserService extends AbstractService<UserEntity, String>
    ...
    @Autowired(required = false)
    private PasswordEncoder passwordEncoder = (password, salt) -> DigestUtils.md5Hex(String.format("ssitao-code.%s.framework.%s", password, salt));
    ...
    public UserEntity selectByUserNameAndPassword(String plainUsername, String plainPassword) {
        ...
        UserEntity userEntity = selectByUsername(plainUsername);
    ...
    public UserEntity selectByPk(String id) {
        ...
        if (null != userEntity) {
            ...
            try {
                BeanUtils.copyProperties(roleUserEntity,userEntity);
