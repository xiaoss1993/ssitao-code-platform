package com.ssitao.code.modular.file.controller;

import com.alibaba.fastjson.JSON;
import io.swagger.annotations.*;
import org.apache.commons.codec.binary.Base64;
import com.ssitao.code.modular.expands.compress.Compress;
import com.ssitao.code.modular.expands.compress.zip.ZIPWriter;
import com.ssitao.code.modular.expands.utils.StringUtils;
import com.ssitao.code.modular.common.utils.BusinessException;
import com.ssitao.code.modular.common.utils.NotFoundException;
import com.ssitao.code.modular.iam.authorization.Authentication;
import com.ssitao.code.modular.iam.authorization.annotation.Authorize;
import com.ssitao.code.modular.common.entity.DataStatus;
import com.ssitao.code.modular.common.controller.message.ResponseMessage;
import com.ssitao.code.modular.file.entity.FileInfoEntity;
import com.ssitao.code.modular.file.service.FileInfoService;
import com.ssitao.code.modular.file.service.FileService;
 ...
 */
@RestController
@RequestMapping("${ssitao.code.web.mappings.file:file}")
...
public class FileController {
    ...
    /**
     * 上传文件,支持多文件上传.获取到文件流后,调用{@link FileService#saveFile(InputStream, String, String, String)}进行文件保存
