...
import com.ssitao.code.modular.dynamic.form.service.simple.dict.EnumDictValueConverter;
...
import com.ssitao.code.frame.ezorm.core.ObjectWrapperFactory;
import com.ssitao.code.frame.ezorm.core.Trigger;
import com.ssitao.code.frame.ezorm.core.ValidatorFactory;
import com.ssitao.code.frame.ezorm.core.ValueConverter;
import com.ssitao.code.frame.ezorm.rdb.RDBDatabase;
import com.ssitao.code.frame.ezorm.rdb.meta.Correlation;
import com.ssitao.code.frame.ezorm.rdb.meta.RDBColumnMetaData;
import com.ssitao.code.frame.ezorm.rdb.meta.RDBTableMetaData;
import com.ssitao.code.frame.ezorm.rdb.meta.converter.BlobValueConverter;
import com.ssitao.code.frame.ezorm.rdb.meta.converter.ClobValueConverter;
import com.ssitao.code.frame.ezorm.rdb.meta.converter.DateTimeConverter;
import com.ssitao.code.frame.ezorm.rdb.meta.converter.DefaultValueConverter;
import com.ssitao.code.frame.ezorm.rdb.meta.converter.JSONValueConverter;
import com.ssitao.code.frame.ezorm.rdb.meta.converter.NumberValueConverter;
import com.ssitao.code.frame.ezorm.rdb.render.dialect.Dialect;
import com.ssitao.code.frame.ezorm.rdb.simple.trigger.ScriptTraggerSupport;
import com.ssitao.code.commons.utils.BusinessException;
import com.ssitao.code.commons.entity.DataStatus;
import com.ssitao.code.modular.dynamic.form.dao.DynamicFormColumnDao;
import com.ssitao.code.modular.dynamic.form.dao.DynamicFormDao;
import com.ssitao.code.commons.utils.dict.EnumDict;
import com.ssitao.code.modular.dynamic.form.entity.DictConfig;
...
import com.ssitao.code.modular.dynamic.form.entity.DynamicFormDeployLogEntity;
import com.ssitao.code.modular.dynamic.form.entity.DynamicFormEntity;
import com.ssitao.code.commons.utils.id.IDGenerator;
import com.ssitao.code.commons.service.DefaultDSLDeleteService;
import com.ssitao.code.commons.service.DefaultDSLQueryService;
import com.ssitao.code.commons.service.DefaultDSLUpdateService;
import com.ssitao.code.commons.service.GenericEntityService;
import com.ssitao.code.modular.dynamic.form.service.events.FormDeployEvent;
import com.ssitao.code.modular.dynamic.form.service.initialize.ColumnInitializeContext;
import com.ssitao.code.modular.dynamic.form.service.initialize.DynamicFormInitializeCustomizer;
import com.ssitao.code.modular.dynamic.form.service.initialize.TableInitializeContext;
import com.ssitao.code.commons.utils.validator.group.CreateGroup;
import com.ssitao.code.commons.utils.validator.group.UpdateGroup;
...
public class SimpleDynamicFormService extends GenericEntityService<DynamicFormEntity, String>
    ...
    @Value("${ssitao.dynamic-form.tags:none}")
    private String[] tags;

    @Value("${ssitao.dynamic-form.tag:none}")
    private String tag;

    @Value("${ssitao.dynamic-form.load-only-tags:null}")
