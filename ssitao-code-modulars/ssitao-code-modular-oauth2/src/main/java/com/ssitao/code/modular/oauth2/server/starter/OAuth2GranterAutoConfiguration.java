...
import com.tweb.frame.authorization.oauth2.server.support.AbstractAuthorizationService;
import com.tweb.frame.authorization.oauth2.server.support.DefaultOAuth2Granter;
import com.tweb.frame.authorization.oauth2.server.support.client.ClientCredentialGranter;
import com.tweb.frame.authorization.oauth2.server.support.client.DefaultClientCredentialGranter;
import com.tweb.frame.authorization.oauth2.server.support.code.AuthorizationCodeGranter;
import com.tweb.frame.authorization.oauth2.server.support.code.AuthorizationCodeService;
import com.tweb.frame.authorization.oauth2.server.support.code.DefaultAuthorizationCodeGranter;
import com.tweb.frame.authorization.oauth2.server.support.implicit.DefaultImplicitGranter;
import com.tweb.frame.authorization.oauth2.server.support.implicit.ImplicitGranter;
import com.tweb.frame.authorization.oauth2.server.support.password.DefaultPasswordGranter;
import com.tweb.frame.authorization.oauth2.server.support.password.PasswordGranter;
import com.tweb.frame.authorization.oauth2.server.support.password.PasswordService;
import com.tweb.frame.authorization.oauth2.server.support.refresh.DefaultRefreshTokenGranter;
import com.tweb.frame.authorization.oauth2.server.support.refresh.RefreshTokenGranter;
...
import com.ssitao.code.modular.oauth2.server.service.simple.*;
 ...
 */
@Configuration
@ComponentScan({"com.ssitao.code.modular.oauth2.server.service.simple"
        , "com.ssitao.code.modular.oauth2.server.controller"})
public class OAuth2GranterAutoConfiguration {
    ...
    public static class OAuth2GranterConfiguration {
        ...
        @ConfigurationProperties(prefix = "tweb.oauth2.server")
