...
import com.tweb.frame.authorization.oauth2.server.support.client.HttpClientCredentialRequest;
import com.tweb.frame.authorization.oauth2.server.support.code.HttpAuthorizationCodeTokenRequest;
import com.tweb.frame.authorization.oauth2.server.support.implicit.HttpImplicitRequest;
import com.tweb.frame.authorization.oauth2.server.support.password.HttpPasswordRequest;
import com.tweb.frame.authorization.oauth2.server.support.refresh.HttpRefreshTokenRequest;
...
import com.ssitao.code.modular.oauth2.model.AccessTokenModel;
...
@RequestMapping("${tweb.web.mappings.authorize-oauth2:oauth2/token}")
