package com.ssitao.code.modular.database.controller;

import com.tweb.commons.controller.message.ResponseMessage;
import com.tweb.commons.utils.Sqls;
import com.tweb.frame.authorization.Permission;
import com.tweb.frame.authorization.annotation.Authorize;
import com.tweb.frame.datasource.DataSourceHolder;
import com.tweb.frame.ezorm.rdb.executor.SqlExecutor;
import com.tweb.frame.ezorm.rdb.meta.RDBDatabaseMetaData;
import com.tweb.frame.ezorm.rdb.meta.builder.TableBuilder;
import com.tweb.frame.ezorm.rdb.meta.parser.MysqlTableMetaParser;
import com.tweb.frame.ezorm.rdb.render.dialect.MysqlRDBDatabaseMetaData;
import com.tweb.frame.ezorm.rdb.simple.SimpleDatabase;
...
import com.ssitao.code.modular.database.service.sql.TransactionInfo;
...
public class DataBaseManagerController {
    ...
    @GetMapping("/executeDatabase")
    @ResponseBody
    public ResponseMessage<TableBuilder> executeDatabase(){
        ...
        try {
           database.createOrAlter("s_user1")
           ...
           log.error("执行数据库结构变更异常{}",e.getMessage());
        }
