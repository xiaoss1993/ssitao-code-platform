...
import com.ssitao.code.frame.mybatisflex.core.constant.FuncName;
import com.ssitao.code.frame.mybatisflex.core.exception.FlexAssert;
import com.ssitao.code.frame.mybatisflex.core.field.FieldQueryBuilder;
import com.ssitao.code.frame.mybatisflex.core.mybatis.MappedStatementTypes;
import com.ssitao.code.frame.mybatisflex.core.paginate.Page;
import com.ssitao.code.frame.mybatisflex.core.provider.EntitySqlProvider;
import com.ssitao.code.frame.mybatisflex.core.query.CPI;
import com.ssitao.code.frame.mybatisflex.core.query.FunctionQueryColumn;
...
import static com.ssitao.code.frame.mybatisflex.core.query.QueryMethods.count;
...
public interface BaseMapper<T> {
     ...
     * @return 实体类数据
     */
    default @Nullable T selectOneByEntityId(@NonNull T entity) {
        FlexAssert.notNull(entity, "entity can not be null");
        TableInfo tableInfo = TableInfoFactory.ofEntityClass(entity.getClass());
        Object[] pkArgs = tableInfo.buildPkSqlArgs(entity);
     ...
     * @return 实体类数据
     */
    default @Nullable T selectOneByMap(@NonNull Map<String, Object> whereConditions) {
        FlexAssert.notEmpty(whereConditions, "whereConditions");
     ...
     * @return 实体类数据
     */
    default @Nullable T selectOneByCondition(@NonNull QueryCondition whereConditions) {
        FlexAssert.notNull(whereConditions, "whereConditions");
        return selectOneByQuery(QueryWrapper.create().where(whereConditions));
    }
     ...
     * @return 实体类数据
     */
    default @Nullable T selectOneByQuery(@NonNull QueryWrapper queryWrapper) {
     ...
     * @return 实体类数据
     */
    default @Nullable T selectOneWithRelationsById(@NonNull Serializable id) {
