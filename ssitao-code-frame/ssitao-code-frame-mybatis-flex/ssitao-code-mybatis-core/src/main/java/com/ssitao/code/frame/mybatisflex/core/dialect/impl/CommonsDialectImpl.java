...
package com.ssitao.code.frame.mybatisflex.core.dialect.impl;

import com.ssitao.code.frame.mybatisflex.core.dialect.IDialect;
import com.ssitao.code.frame.mybatisflex.core.dialect.KeywordWrap;
import com.ssitao.code.frame.mybatisflex.core.dialect.LimitOffsetProcessor;
...
import com.ssitao.code.frame.mybatisflex.core.logicdelete.LogicDeleteManager;
...
import com.ssitao.code.frame.mybatisflex.core.query.QueryOrderBy;
import com.ssitao.code.frame.mybatisflex.core.query.QueryTable;
import com.ssitao.code.frame.mybatisflex.core.query.QueryWrapper;
import com.ssitao.code.frame.mybatisflex.core.query.UnionWrapper;
import com.ssitao.code.frame.mybatisflex.core.query.With;
import com.ssitao.code.frame.mybatisflex.core.row.Row;
import com.ssitao.code.frame.mybatisflex.core.row.RowCPI;
...
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.AND;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.IN;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.ASTERISK;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.BLANK;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.BRACKET_LEFT;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.BRACKET_RIGHT;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.DELETE;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.DELETE_FROM;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.DELIMITER;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.DUAL;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.EMPTY;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.EQUALS;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.EQUALS_PLACEHOLDER;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.FROM;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.GROUP_BY;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.HAVING;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.HINT_END;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.HINT_START;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.INSERT_INTO;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.OR;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.ORDER_BY;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.PLACEHOLDER;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.REFERENCE;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.SELECT;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.SELECT_ALL_FROM;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.SEMICOLON;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.SET;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.UPDATE;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.VALUES;
import static com.ssitao.code.frame.mybatisflex.core.constant.SqlConsts.WHERE;
...
//        return ASTERISK.equals(keyword) ? keyword : keywordWrap.getPrefix() + keyword + keywordWrap.getSuffix();
    ...
    protected void assertPrimaryKeysNotEmpty(String[] primaryKeys) {
        if (Objects.isNull(primaryKeys) || primaryKeys.length == 0 || Arrays.stream(primaryKeys).allMatch(String::isEmpty)) {
            throw FlexExceptions.wrap("primary key not recognized! Please check the @com.ssitao.code.frame.mybatisflex.annotation.Id annotation");
        }
    }
}
