...
import com.ssitao.code.frame.mybatisflex.codegen.config.ColumnConfig;
import com.ssitao.code.frame.mybatisflex.codegen.config.EntityConfig;
import com.ssitao.code.frame.mybatisflex.core.mask.MaskManager;
import com.ssitao.code.frame.mybatisflex.core.mask.Masks;
    ...
    public Set<String> getImportClasses() {
        ...
        if (columnConfig != null) {
            ...
            if (columnConfig.getOnInsertValue() != null
                    ...
                    || needGenColumnAnnotation) {
                addImportClass(importClasses, com.ssitao.code.frame.mybatisflex.annotation.Column.class.getName());
            }
        }
