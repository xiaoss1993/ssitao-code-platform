...
@Table("tb_iam_developer_org")
public class TbIamDeveloperOrg extends BaseEntity implements Serializable {
     ...
     */
    @Id
    private String tbIamDevelopOrgId;
