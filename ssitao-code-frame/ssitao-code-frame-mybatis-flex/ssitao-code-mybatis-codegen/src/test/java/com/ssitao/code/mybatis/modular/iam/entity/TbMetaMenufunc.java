...
@Table("tb_meta_menufunc")
public class TbMetaMenufunc extends BaseEntity implements Serializable {
     ...
     */
    @Id
    private String tbMetaMenufuncId;
     ...
     * 功能编码
     */
    private String menufuncFunccode;

    /**
     * 是否启用
     */
    private String menufuncEnabled;
