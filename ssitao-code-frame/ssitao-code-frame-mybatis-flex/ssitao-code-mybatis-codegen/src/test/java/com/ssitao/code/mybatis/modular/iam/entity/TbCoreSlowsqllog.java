...
@Table("tb_core_slowsqllog")
public class TbCoreSlowsqllog extends BaseEntity implements Serializable {
     ...
     */
    @Id
    private String tbCoreSlowsqllogId;
     ...
     * 执行的方法名
     */
    private String excuteMethodName;
