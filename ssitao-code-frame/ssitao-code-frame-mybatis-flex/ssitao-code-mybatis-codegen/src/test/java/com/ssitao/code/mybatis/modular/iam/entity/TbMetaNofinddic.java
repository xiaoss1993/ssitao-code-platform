...
@Table("tb_meta_nofinddic")
public class TbMetaNofinddic extends BaseEntity implements Serializable {
     ...
     */
    @Id
    private String tbMetaNofinddicId;

    /**
     * 字典编码
     */
    private String nofinddicDicCode;

    /**
     * 所属模块
     */
    private String nofinddicSsmk;
