 ...
 * @since 2026-02-16
 */
public class TbCoreQjcssTableDef extends TableDef {
     ...
     * 全局样式库
     */
    public static final TbCoreQjcssTableDef TB_CORE_QJCSS = new TbCoreQjcssTableDef();
     ...
     * 样式名
     */
    public final QueryColumn QJCSS_YSM = new QueryColumn(this, "qjcss_ysm");
     ...
     * 样式代码
     */
    public final QueryColumn QJCSS_YSDM = new QueryColumn(this, "qjcss_ysdm");
     ...
     * 启用
     */
    public final QueryColumn QJCSS_QY_CODE = new QueryColumn(this, "qjcss_qy_code");

    /**
     * 样式功能描述
     */
    public final QueryColumn QJCSS_YSGNMS = new QueryColumn(this, "qjcss_ysgnms");
     ...
     * 脚本样式作用范围
     */
    public final QueryColumn QJCSS_ZYFW_CODE = new QueryColumn(this, "qjcss_zyfw_code");

    /**
     * 脚本样式作用范围_name
     */
    public final QueryColumn QJCSS_ZYFW_NAME = new QueryColumn(this, "qjcss_zyfw_name");
     ...
     * 主键id
     */
    public final QueryColumn TB_CORE_QJCSS_ID = new QueryColumn(this, "tb_core_qjcss_id");
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{TB_CORE_QJCSS_ID, QJCSS_YSDM, QJCSS_YSGNMS, QJCSS_QY_CODE, QJCSS_ZYFW_NAME, QJCSS_ZYFW_CODE, QJCSS_YSM, SY_CREATEORGID, SY_CREATEORGNAME, SY_CREATETIME, SY_CREATEUSERID, SY_CREATEUSERNAME, SY_STATUS, SY_ORDERINDEX, SY_MODIFYORGID, SY_MODIFYORGNAME, SY_MODIFYUSERID, SY_MODIFYUSERNAME, SY_MODIFYTIME, SY_COMPANY_ID, SY_COMPANY_NAME, SY_GROUP_COMPANY_ID, SY_GROUP_COMPANY_NAME, SY_ORG_ID, SY_TENANT_ID, SY_TENANT_NAME};

    public TbCoreQjcssTableDef() {
        super("", "tb_core_qjcss");
    }

    private TbCoreQjcssTableDef(String schema, String name, String alisa) {
        super(schema, name, alisa);
    }

    public TbCoreQjcssTableDef as(String alias) {
        String key = getNameWithSchema() + "." + alias;
        return getCache(key, k -> new TbCoreQjcssTableDef("", "tb_core_qjcss", alias));
    }
