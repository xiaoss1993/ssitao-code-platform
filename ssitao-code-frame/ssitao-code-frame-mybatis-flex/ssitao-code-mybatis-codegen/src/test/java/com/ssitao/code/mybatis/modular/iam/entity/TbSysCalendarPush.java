...
@Table("tb_sys_calendar_push")
public class TbSysCalendarPush extends BaseEntity implements Serializable {
     ...
     */
    @Id
    private String tbSysCalendarPushId;
