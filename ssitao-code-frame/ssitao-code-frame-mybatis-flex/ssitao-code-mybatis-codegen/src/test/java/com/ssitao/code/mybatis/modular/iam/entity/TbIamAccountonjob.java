...
@Table("tb_iam_accountonjob")
public class TbIamAccountonjob extends BaseEntity implements Serializable {
     ...
     * 统计日期
     */
    private String accountonjobTjrq;

    /**
     * 统计数量
     */
    private String accountonjobTjsl;
