package com.ssitao.code.frame.aggregate.sample.hierarchymodel.domain.repository;
...
import com.ssitao.code.frame.aggregate.sample.hierarchicalmodel.command.domain.entity.DeliveryOrderInfo;
 ...
 */
public class DeliveryBookingPricedOrderRepositoryTest extends AbstractTestCase {
    ...
    public void given_existed_order_when_delete_then_removed_correctly() {
        ...
        Assert.assertTrue(foundOrder.isDeleted());
