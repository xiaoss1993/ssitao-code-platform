package com.ssitao.code.frame.aggregate.sample.hierarchymodel.infrastructure.dao;

import com.ssitao.code.frame.aggregate.sample.AbstractTestCase;
import com.ssitao.code.frame.aggregate.sample.complexmodel.command.infrastructure.dao.BookingOrderDao;
import com.ssitao.code.frame.aggregate.sample.hierarchicalmodel.command.domain.entity.DeliveryOrder;
import com.ssitao.code.frame.aggregate.sample.hierarchicalmodel.command.domain.entity.HierarchicalOrder;
import com.ssitao.code.frame.aggregate.sample.hierarchicalmodel.command.domain.entity.JobOrder;
import com.ssitao.code.frame.aggregate.sample.hierarchicalmodel.command.infrastructure.dao.HierarchicalOrderDao;
