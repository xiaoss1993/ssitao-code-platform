package com.ssitao.code.frame.aggregate.sample.complexmodel.domain.repositorytest;

import com.ssitao.code.frame.aggregate.sample.complexmodel.OrderTestCase;
import com.ssitao.code.frame.aggregate.sample.complexmodel.command.domain.entity.BookingOrder;
import com.ssitao.code.frame.aggregate.sample.complexmodel.command.domain.entity.BookingPayment;
import com.ssitao.code.frame.aggregate.sample.complexmodel.command.domain.entity.SeatAvailability;
import com.ssitao.code.frame.aggregate.sample.complexmodel.command.domain.repository.JpaOrderRepository;
 ...
 * Time: 下午4:30
 */
public class PricedOrderRepositoryTest extends OrderTestCase {
...
//        XdcsTool.clearPeakRequestVal();
    ...
    public void given_a_persisted_order_when_transactional_update_the_root_then_order_updated() {
        ...
        expectedBookingOrder.updateContent("sample 2 update");
