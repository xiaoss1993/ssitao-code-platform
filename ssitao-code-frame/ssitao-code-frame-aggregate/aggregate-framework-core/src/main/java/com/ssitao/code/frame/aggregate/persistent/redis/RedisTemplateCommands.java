...
public class RedisTemplateCommands implements RedisCommands {
    ...
    public Long renamenx(byte[] oldkey, byte[] newkey) {
        throw new UnsupportedOperationException("RedisTemplateCommand not support rename!");
    }
        ...
        return redisTemplate.executePipelined(new SessionCallback<Object>() {
            ...
            public Object execute(RedisOperations operations) throws DataAccessException {
                ...
                return commandCallback.execute(new RedisCommands() {
                    ...
                    @Override
                    public Long renamenx(byte[] oldkey, byte[] newkey) {
                        throw new UnsupportedOperationException("renamenx in RedisOperation unsupport right now!");
                    }
