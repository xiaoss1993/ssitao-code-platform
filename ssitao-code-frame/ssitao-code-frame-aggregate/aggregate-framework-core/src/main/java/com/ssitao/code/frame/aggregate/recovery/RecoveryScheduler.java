...
public class RecoveryScheduler {
    ...
    public static final String JOB_NAME = "AGG_JOB_%s";
    public static final String TRIGGER_NAME = "AGG_TRIGGER_%s";
    ...
    private Scheduler createScheduler(String domain) {
        ...
        if (recoveryConfig.isQuartzClustered()) {
            ...
            if (StringUtils.isEmpty(recoveryConfig.getCustomConnectionProviderClassName())) {
                conf.put("org.quartz.dataSource.myDS.connectionProvider.class", "com.ssitao.code.frame.aggregate.recovery.ReusableConnectionProvider");
                ...
                for (Map.Entry<String, String> entry : recoveryConfig.getCustomConnectionProviderProperties().entrySet()) {
