...
import com.ssitao.code.frame.aggregate.exception.NoDaoDefinitionException;
...
public class AggreateDaoFactory {
    ...
    public synchronized static <E extends DomainObject<ID>, ID extends Serializable> DomainObjectDao<E, ID> getDao(Class<E> entityClass) {
        ...
        if (foundDao == null) {
            ...
            Map<String, DomainObjectDao> daos = FactoryBuilder.getFactory(BeanFactory.class).getBeansOfType(DomainObjectDao.class);
