...
import com.ssitao.code.frame.aggregate.storage.StorageRecoverable;
...
import com.ssitao.code.frame.aggregate.utils.AggDateFormatUtils;
...
public abstract class BaseDomainServiceImpl implements DomainService {
    ...
    private DomainStoreDto transferToDomainStoreDto(DomainStore domainStore) {
        ...
        domainStoreDto.setLastAlertTime(AggDateFormatUtils.formatDate(domainStore.getLastAlertTime()));
        domainStoreDto.setDingRobotUrl(domainStore.getDingRobotUrl());
        domainStoreDto.setCreateTime(AggDateFormatUtils.formatDate(domainStore.getCreateTime()));
        domainStoreDto.setLastUpdateTime(AggDateFormatUtils.formatDate(domainStore.getLastUpdateTime()));
