package com.ssitao.code.frame.aggregate.alert;
...
import com.ssitao.code.frame.aggregate.utils.AlertUtils;
...
public class AlertManager {
    ...
    private static final String ALERT_CONTENT_TEMPLATE = "【AGG告警】\n" +
            "Domain: $domain$\n" +
            "当前AGG事件堆积数：$errorCount$，超过阈值: $threshold$\n" +
