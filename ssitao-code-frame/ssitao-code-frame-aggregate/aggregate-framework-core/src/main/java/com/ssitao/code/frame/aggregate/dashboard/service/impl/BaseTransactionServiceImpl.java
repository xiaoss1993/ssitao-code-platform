...
import com.ssitao.code.frame.aggregate.dashboard.dto.*;
import com.ssitao.code.frame.aggregate.dashboard.service.TransactionService;
...
public abstract class BaseTransactionServiceImpl implements TransactionService {
    ...
    protected TransactionStoreDto toTransactionStoreDto(TransactionStore transactionStore) {
        ...
        transactionStoreDto.setCreateTime(AggDateFormatUtils.formatDate(transactionStore.getCreateTime()));
        transactionStoreDto.setLastUpdateTime(AggDateFormatUtils.formatDate(transactionStore.getLastUpdateTime()));
