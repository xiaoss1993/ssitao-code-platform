...
public class MemoryTransactionStorage extends AbstractKVTransactionStorage<Map<String, TransactionStore>> {
    ...
    @Override
    protected Page<String> findKeysFromOneShard(String domain, Map<String, TransactionStore> shard, String currentCursor, int maxFindCount, boolean isMarkDeleted) {
    ...
    @Override
    protected int count(String domain, Map<String, TransactionStore> shard, boolean isMarkDeleted) {
        int count = 0;
    ...
    protected int doUpdate(TransactionStore transactionStore) {
        ...
        if (db.compute(buildMemoryKey(transactionStore), (key, oldValue) -> {
            if (oldValue == null || oldValue.getVersion() != transactionStore.getVersion() - 1) {
                ...
                transactionStore.setContent(oldValue.getContent());
    ...
    private void trace(String action, TransactionStore transactionStore) {
        ...
        sb.append("transactionStore xid:" + transactionStore.getXid() + ";\r\n");
