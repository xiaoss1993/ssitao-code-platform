package com.ssitao.code.frame.aggregate.properties;
...
public class RecoveryProperties implements RecoveryConfig {
    ...
    private String quartzDataSourceUrl = "jdbc:mysql://localhost:3306/AGG_SERVER?useSSL=false&allowPublicKeyRetrieval=true&connectTimeout=1000&socketTimeout=5000";
