...
public abstract class AbstractKVTransactionStorage<T> extends AbstractTransactionStorage implements StorageRecoverable {
    ...
    protected abstract Page findKeysFromOneShard(String domain, T shard, String currentCursor, int maxFindCount, boolean isMarkDeleted);

    protected abstract int count(String domain, T shard, boolean isMarkDeleted);
