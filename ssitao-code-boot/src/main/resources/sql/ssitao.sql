...
CREATE TABLE `iam_department` (
  ...
  `dept_address` varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部门地址',
...
CREATE TABLE `iam_permission` (
  ...
  `permission_type` varchar(20) COLLATE utf8mb4_general_ci NOT NULL COMMENT '权限类型: MENU-菜单, BUTTON-按钮, API-接口, DATA-数据',
  `permission_resource` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '资源标识',
  `permission_action` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '操作类型',
...
CREATE TABLE `iam_role` (
  ...
  `role_type` varchar(20) COLLATE utf8mb4_general_ci DEFAULT 'BUSINESS' COMMENT '角色类型: SYSTEM-系统角色, BUSINESS-业务角色',
